...
export default function DashboardLayout({
  ...
  useEffect(() => {
    ...
    if (token) {
      ...
      router.push('/job-portal/auth/sign-in?returnUrl=/job-portal/dashboard')
    }
  }, [router])
  ...
  const navItems = [
    { icon: User, label: "Profile", href: "/job-portal/dashboard" },
    { icon: Briefcase, label: "Applications", href: "/job-portal/dashboard/applications" },
    { icon: FileText, label: "Resume", href: "/job-portal/dashboard/resume" },
  ]
